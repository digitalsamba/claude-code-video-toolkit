      ...
      <div
        style={{
          ...
          background: `
            ...
            radial-gradient(ellipse at 80% 70%, ${theme.colors.accent || theme.colors.primaryLight}10 0%, transparent 50%)
          `,
        }}
      />
      ...
      {shapes.map((shape, i) => (
        <div
          ...
          style={{
            ...
            border: `1px solid ${i % 2 === 0 ? theme.colors.primary : (theme.colors.accent || theme.colors.primaryLight)}`,
